...
urlpatterns = [
    ...
    re_path(r'(?P<user_id>[0-9]+)/(?P<company_id>[0-9]+)/pay_st_1/$', views.pay_st1, name='pay_st_1'),
    re_path(r'(?P<user_id>[0-9]+)/(?P<company_id>[0-9]+)/pay_st_2/$', views.pay_st2, name='pay_st_2'),
    re_path(r'(?P<user_id>[0-9]+)/(?P<company_id>[0-9]+)/pay_final/$', views.pay_final, name='pay_final'),
